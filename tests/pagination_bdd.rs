//! Behavioural tests for the pagination foundation.
...
fn pagination_crate_foundation(world: World) { drop(world); }

#[scenario(path = "tests/features/direction_aware_cursors.feature")]
fn direction_aware_cursor_pagination(world: World) { drop(world); }
