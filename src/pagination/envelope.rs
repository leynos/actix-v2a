...
impl PaginationLinks {
    ...
    ///
    /// ```rust
    /// use actix_v2a::pagination::PaginationLinks;
    ///
    ...
    ///
    /// ```rust
    /// use actix_v2a::pagination::{PageParams, PaginationLinks};
    /// use url::Url;
    ///
    /// let request_url =
    ///     Url::parse("https://example.test/api/v1/users?role=admin&limit=1&cursor=stale")
...
impl<T> Paginated<T> {
    ...
    ///
    /// ```rust
    /// use actix_v2a::pagination::{Paginated, PaginationLinks};
    ///
...
mod tests {
    ...
    use crate::pagination::{PageParams, Paginated, PaginationLinks};
